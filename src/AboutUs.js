            ...
            <div className="mainBlock">
                ...
                <div id="aboutText">
                    <div className="subBlock">
                        <img className="image-right" src="industrial-worker-checking-pressure-natural-gas-pipeline-inside-power-plant-refinery_308072-2675.png"/>
                    ...
                    <div className="subBlock">
                        <img className="image-left" src="full-list-of-oil-refineries-in-louisiana.jpg"/>
                    ...
                    <div className="subBlock">
                        <img className="image-right" src="happy_oil_worker.jpg"/>
